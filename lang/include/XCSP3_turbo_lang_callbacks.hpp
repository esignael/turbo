...
#ifndef XCSP3_TURBO_LANG_CALLBACKS_HPP
#define XCSP3_TURBO_LANG_CALLBACKS_HPP
...
namespace XCSP3Core {
    ...
    class XCSP3_turbo_lang_callbacks : public XCSP3CoreCallbacks {
    public:
        ...
        XCSP3_turbo_lang_callbacks(Compiler& compiler);
...
XCSP3_turbo_lang_callbacks::XCSP3_turbo_lang_callbacks(Compiler& compiler)
  : XCSP3CoreCallbacks(), canonize(true), compiler(compiler) {}
...
void XCSP3_turbo_lang_callbacks::beginInstance(InstanceType type) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::endInstance() {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::beginVariables() {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::endVariables() {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::beginVariableArray(string id) {
  if(debug) {
    cout << "    array: " << id << endl;
  }
}
...
void XCSP3_turbo_lang_callbacks::endVariableArray() {
}


void XCSP3_turbo_lang_callbacks::beginConstraints() {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::endConstraints() {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::beginGroup(string id) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::endGroup() {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::beginBlock(string classes) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::endBlock() {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::beginSlide(string id, bool) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::endSlide() {
  if(debug) {
    cout << "   end slide" << endl;
  }
  throw std::runtime_error("constraint unsupported");
...
void XCSP3_turbo_lang_callbacks::beginObjectives() {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::endObjectives() {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::beginAnnotations() {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::endAnnotations() {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildVariableInteger(string id, int minValue, int maxValue) {
  if(debug) {
    cout << "    var " << id << " : " << minValue << "..." << maxValue << endl;
  }
  compiler.variable(id, minValue, maxValue);
}


void XCSP3_turbo_lang_callbacks::buildVariableInteger(string id, vector<int> &values) {
  if(debug) {
    cout << "    var " << id << " : ";
    cout << "        ";
    displayList(values);
...
void XCSP3_turbo_lang_callbacks::buildConstraintExtension(string id, vector<XVariable *> list, vector<vector<int>> &tuples, bool support, bool hasStar) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintExtension(string id, XVariable *variable, vector<int> &tuples, bool support, bool hasStar) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintExtensionAs(string id, vector<XVariable *>, bool, bool) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintIntension(string id, string expr) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintIntension(string id, Tree *tree) {
  if(debug) {
    cout << "\n    intension constraint using canonized tree: " << id << " : ";
    tree->prefixe();
    std::cout << "\n";
  }
  compiler.constraint(tree);
}

void XCSP3_turbo_lang_callbacks::buildConstraintPrimitive(string id, OrderType op, XVariable *x, int k, XVariable *y) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintPrimitive(string id, OrderType op, XVariable *x, int k) {
  if(debug) {
    cout << "\n   constraint  " << id << ":" << x->id << " op " << k << "\n";
  }
  compiler.unary_constraint(x->id, op, k);
}

void XCSP3_turbo_lang_callbacks::buildConstraintPrimitive(string id, XVariable *x, bool in, int min, int max) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintRegular(string, vector<XVariable *> &list, string start, vector<string> &final, vector<XTransition> &transitions) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintMDD(string, vector<XVariable *> &list, vector<XTransition> &transitions) {
  if(debug) {
    cout << "\n    mdd constraint" << endl;
    cout << "        ";
    displayList(list);
...
void XCSP3_turbo_lang_callbacks::buildConstraintAlldifferent(string id, vector<XVariable *> &list) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintAlldifferentExcept(string id, vector<XVariable *> &list, vector<int> &except) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintAlldifferent(string id, vector<Tree *> &list) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintAlldifferentList(string id, vector<vector<XVariable *>> &lists) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintAlldifferentMatrix(string id, vector<vector<XVariable *>> &matrix) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintAllEqual(string id, vector<XVariable *> &list) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintNotAllEqual(string id, vector<XVariable *> &list) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintOrdered(string, vector<XVariable *> &list, OrderType order) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintOrdered(string, vector<XVariable *> &list, vector<int> &lengths, OrderType order) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintLex(string, vector<vector<XVariable *>> &lists, OrderType order) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintLexMatrix(string, vector<vector<XVariable *>> &matrix, OrderType order) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintSum(string, vector<XVariable *> &list, vector<int> &coeffs, XCondition &cond) {
  if(debug) {
    cout << "\n        sum constraint:";
    if(list.size() > 8) {
        for(int i = 0; i < 3; i++)
...
void XCSP3_turbo_lang_callbacks::buildConstraintSum(string, vector<XVariable *> &list, XCondition &cond) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintSum(string, vector<XVariable *> &list, vector<XVariable *> &coeffs, XCondition &cond) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintSum(string id, vector<Tree *> &list, vector<int> &coeffs, XCondition &cond) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintSum(string id, vector<Tree *> &list, XCondition &cond) {
  if(debug) {
    if(list.size() > 8) {
        for(int i = 0; i < 3; i++) {
            list[i]->prefixe();
...
void XCSP3_turbo_lang_callbacks::buildConstraintAtMost(string, vector<XVariable *> &list, int value, int k) {
  if(debug) {
...
// string id, vector<XVariable *> &list, int value, int k
void XCSP3_turbo_lang_callbacks::buildConstraintAtLeast(string, vector<XVariable *> &list, int value, int k) {
  if(debug) {
...
// string id, vector<XVariable *> &list, int value, int k
void XCSP3_turbo_lang_callbacks::buildConstraintExactlyK(string, vector<XVariable *> &list, int value, int k) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintAmong(string, vector<XVariable *> &list, vector<int> &values, int k) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintExactlyVariable(string, vector<XVariable *> &list, int value, XVariable *x) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintCount(string, vector<XVariable *> &list, vector<int> &values, XCondition &xc) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintCount(string, vector<XVariable *> &list, vector<XVariable *> &values, XCondition &xc) {
  if(debug) {
    cout << "\n    count constraint" << endl;
    cout << "        ";
    displayList(list);
...
void XCSP3_turbo_lang_callbacks::buildConstraintNValues(string, vector<XVariable *> &list, vector<int> &except, XCondition &xc) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintNValues(string, vector<XVariable *> &list, XCondition &xc) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintCardinality(string, vector<XVariable *> &list, vector<int> values, vector<int> &occurs, bool closed) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintCardinality(string, vector<XVariable *> &list, vector<int> values, vector<XVariable *> &occurs, bool closed) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintCardinality(string, vector<XVariable *> &list, vector<int> values, vector<XInterval> &occurs, bool closed) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintCardinality(string, vector<XVariable *> &list, vector<XVariable *> values, vector<int> &occurs, bool closed) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintCardinality(string, vector<XVariable *> &list, vector<XVariable *> values, vector<XVariable *> &occurs, bool closed) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintCardinality(string, vector<XVariable *> &list, vector<XVariable *> values, vector<XInterval> &occurs, bool closed) {
  if(debug) {
...
// string id, vector<XVariable *> &list, XCondition &xc
void XCSP3_turbo_lang_callbacks::buildConstraintMinimum(string, vector<XVariable *> &list, XCondition &xc) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintMinimum(string, vector<XVariable *> &list, XVariable *index, int startIndex, RankType, XCondition &xc) {
  if(debug) {
...
// string id, vector<XVariable *> &list, XCondition &xc
void XCSP3_turbo_lang_callbacks::buildConstraintMaximum(string, vector<XVariable *> &list, XCondition &xc) {
  if(debug) {
...
// string id, vector<XVariable *> &list, XVariable *index, int startIndex, RankType rank, XCondition &xc
void XCSP3_turbo_lang_callbacks::buildConstraintMaximum(string, vector<XVariable *> &list, XVariable *index, int startIndex, RankType, XCondition &xc) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintElement(string, vector<XVariable *> &list, int value) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintElement(string, vector<XVariable *> &list, XVariable *value) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintElement(string, vector<XVariable *> &list, int startIndex, XVariable *index, RankType, int value) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintElement(string id, vector<vector<int> > &matrix, int startRowIndex, XVariable *rowIndex, int startColIndex, XVariable* colIndex, XVariable *value) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintElement(string, vector<XVariable *> &list, int startIndex, XVariable *index, RankType, XVariable *value) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintElement(string, vector<int> &list, int startIndex, XVariable *index, RankType, XVariable *value) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintChannel(string, vector<XVariable *> &list, int startIndex) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintChannel(string, vector<XVariable *> &list1, int, vector<XVariable *> &list2, int) {
  if(debug) {
    cout << "\n    channel constraint" << endl;
    cout << "        list1 ";
    displayList(list1);
...
void XCSP3_turbo_lang_callbacks::buildConstraintChannel(string, vector<XVariable *> &list, int, XVariable *value) {
  if(debug) {
    cout << "\n    channel constraint" << endl;
    cout << "        ";
    displayList(list);
...
void XCSP3_turbo_lang_callbacks::buildConstraintStretch(string, vector<XVariable *> &list, vector<int> &values, vector<XInterval> &widths) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintStretch(string, vector<XVariable *> &list, vector<int> &values, vector<XInterval> &widths, vector<vector<int>> &patterns) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintNoOverlap(string, vector<XVariable *> &origins, vector<int> &lengths, bool) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintNoOverlap(string, vector<XVariable *> &origins, vector<XVariable *> &lengths, bool) {
  if(debug) {
    cout << "\n    nooverlap constraint" << endl;
    cout << "        origins:";
    displayList(origins);
...
void XCSP3_turbo_lang_callbacks::buildConstraintNoOverlap(string, vector<vector<XVariable *>> &origins, vector<vector<int>> &lengths, bool) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintNoOverlap(string, vector<vector<XVariable *>> &origins, vector<vector<XVariable *>> &lengths, bool) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintInstantiation(string, vector<XVariable *> &list, vector<int> &values) {
  if(debug) {
...
// string id, vector<XVariable *> &list, vector<int> &values
void XCSP3_turbo_lang_callbacks::buildConstraintClause(string, vector<XVariable *> &positive, vector<XVariable *> &negative) {
  if(debug) {
...
// string id, vector<XVariable *> &list, int startIndex
void XCSP3_turbo_lang_callbacks::buildConstraintCircuit(string, vector<XVariable *> &list, int startIndex) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildConstraintCircuit(string, vector<XVariable *> &list, int startIndex, int size) {
  if(debug) {
    cout << "\n    circuit constraint" << endl;
    cout << "        list:";
    displayList(list);
...
void XCSP3_turbo_lang_callbacks::buildConstraintCircuit(string, vector<XVariable *> &list, int startIndex, XVariable *size) {
  if(debug) {
    cout << "\n    circuit constraint" << endl;
    cout << "        list:";
    displayList(list);
...
void XCSP3_turbo_lang_callbacks::buildObjectiveMinimizeExpression(string expr) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildObjectiveMaximizeExpression(string expr) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildObjectiveMinimizeVariable(XVariable *x) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildObjectiveMaximizeVariable(XVariable *x) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildObjectiveMinimize(ExpressionObjective type, vector<XVariable *> &list, vector<int> &coefs) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildObjectiveMaximize(ExpressionObjective type, vector<XVariable *> &list, vector<int> &coefs) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildObjectiveMinimize(ExpressionObjective type, vector<XVariable *> &list) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildObjectiveMaximize(ExpressionObjective type, vector<XVariable *> &list) {
  if(debug) {
...
void XCSP3_turbo_lang_callbacks::buildAnnotationDecision(vector<XVariable*> &list) {
  if(debug) {
